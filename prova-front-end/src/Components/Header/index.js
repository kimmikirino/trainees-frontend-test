...
return(
    <section className = 'header'>
        ...
        <Input label = 'Search' type='text' value={userSearch} placeholder='User' onChange = {handleChange}/>
        <Link to={`/${userSearch}`}><button ><img src={IconSearch} alt='SearchIcon'/></button></Link>
    </section>   
  )
}
